...
public class Objective4Lab1 {
  public static void main(String[] args) {
    ...
    /* input.nextLine() was producing an error that said "could not find symbol" with a carrot underneath
    the i in input. The solution I found was to change imput to keyboard to the the program to compile. */
    ...
    System.out.println("What is your favority food?");
